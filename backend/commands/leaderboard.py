...
def get_leaderboard(lctx, matches_or_sets, sortby, active_only, reverse_order=True):
    ...
    for match in matches:
        ...
        if match.player_1_id == match.winner_id:
            player_dict[match.player_1_id]['games_won'] = player_1['games_won'] + match.player_1_score
            player_dict[match.player_2_id]['games_won'] = player_2['games_won'] + match.player_2_score
